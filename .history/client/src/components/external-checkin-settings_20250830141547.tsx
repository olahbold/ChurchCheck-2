...
const ExternalCheckInSettings: React.FC<ExternalCheckInSettingsProps> = ({ eventId, eventName }) => {
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent
        className="max-w-2xl"
        aria-describedby="external-checkin-description"
      >
        <DialogHeader>
        ...
        <p id="external-checkin-description" className="text-sm text-gray-600">
          Configure the external check-in settings for this event. You can enable or disable external check-in and view the generated URL and PIN.
        </p>
